...
enum {BLACK, D_BLUE, D_GREEN, D_SKYBLUE, D_RED,   // 0:검정색, 1:검파란색, 2:검녹색, 3:검하늘색, 4:검빨간색
	D_YIOLET, D_YELLOW, GRAY, D_GRAY, BLUE,       // 5:검보라색, 6:검노란색, 7:회색, 8:검회색, 9:파란색
	GREEN, SKYBLUE, RED, YIOLET, YELLOW, WHITE, };// 10:녹색, 11:하늘색, 12:빨간색, 13:보라색, 14:노란색, 15:흰색
